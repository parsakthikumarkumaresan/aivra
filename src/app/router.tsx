        ...
        children: [
          {
            ...
            children: [
              ...
              { path: 'ai-employees', element: lazyPage(() => import('@/pages/admin/ai-employees/AdminAiEmployeesPage')) },
              { path: 'ai-employees/jaan', element: lazyPage(() => import('@/pages/admin/ai-employees/AdminJaanBusinessPage')) },
              { path: 'ai-employees/hr', element: lazyPage(() => import('@/pages/admin/ai-employees/AdminHrBusinessPage')) },
              { path: 'sales', element: lazyPage(() => import('@/pages/admin/sales/AdminSalesPage')) },
              ...
              { path: 'agents', element: lazyPage(() => import('@/pages/admin/agents/AdminAgentsPage')) },
              { path: 'agents/:id', element: lazyPage(() => import('@/pages/admin/agents/AdminAgentDetailPage')) },
              { path: 'calls', element: lazyPage(() => import('@/pages/admin/calls/AdminCallsPage')) },
              { path: 'calls/:id', element: lazyPage(() => import('@/pages/admin/calls/AdminCallDetailPage')) },
              { path: 'analytics', element: lazyPage(() => import('@/pages/admin/analytics/AdminAnalyticsPage')) },
              ...
              { path: 'billing', element: lazyPage(() => import('@/pages/admin/billing/AdminBillingPage')) },
              { path: 'quotes', element: lazyPage(() => import('@/pages/admin/quotes/AdminQuotesPage')) },
              { path: 'quotes/new', element: lazyPage(() => import('@/pages/admin/quotes/AdminQuoteNewPage')) },
              { path: 'quotes/:quoteId', element: lazyPage(() => import('@/pages/admin/quotes/AdminQuoteDetailPage')) },
              { path: 'integrations', element: lazyPage(() => import('@/pages/admin/AdminComingSoonPage')) },
              { path: 'telephony', element: lazyPage(() => import('@/pages/admin/telephony/AdminTelephonyPage')) },
              { path: 'monitor', element: lazyPage(() => import('@/pages/admin/monitor/AdminMonitorPage')) },
              { path: 'support', element: lazyPage(() => import('@/pages/admin/support/AdminSupportPage')) },
              { path: 'audit-logs', element: lazyPage(() => import('@/pages/admin/audit/AdminAuditLogsPage')) },
              { path: 'settings', element: lazyPage(() => import('@/pages/admin/settings/AdminSettingsPage')) },
