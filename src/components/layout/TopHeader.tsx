    ...
    <header className="flex h-16 shrink-0 items-center gap-3 border-b border-ink-200 bg-white px-4 sm:px-6">
      ...
      <div className="min-w-0 flex-1">
        {breadcrumbs.length > 0 ? (
          ...
          <span className="text-[15px] font-semibold text-ink-900">AIVRA</span>
        )}
      </div>
      ...
      <div className="hidden items-center sm:flex">
        <div className="relative">
          ...
          <input
            placeholder="Search AIVRA…"
            className="h-9 w-56 rounded-lg border border-ink-200 bg-ink-25 pl-9 pr-3 text-[13px] text-ink-800 placeholder:text-ink-400 transition-colors duration-150 focus:border-brand-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/30 lg:w-72"
          />
        </div>
      </div>
