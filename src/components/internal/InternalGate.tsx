...
// Generic guard for JEXA.AI-internal-only surfaces that live outside the
  ...
  if (!internal) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-ink-25 px-6 text-center">
        ...
        <p className="mt-2 max-w-sm text-[13.5px] text-ink-600">This area is used by the JEXA.AI implementation team to build and operate Voice Employees.</p>
