...
// escalation rule engine, telephony). This is AIVRA-internal functionality,
...
// Settings → Developer → "Enable AIVRA Internal Mode".
export function VoiceAdvancedSetupGate() {
  useSetBreadcrumbs([{ label: 'AI Employees', href: '/app/employees' }, { label: 'AI Voice Employee', href: '/app/employees/voice' }, { label: 'Advanced Setup' }])
  ...
  if (!internal) {
    return (
      <div className="flex min-h-[50vh] flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-2 max-w-sm text-[13.5px] text-ink-600">This configuration is managed by the AIVRA implementation team.</p>
