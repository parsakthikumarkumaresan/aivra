  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[420px] bg-gradient-to-b from-info-50/70 via-white to-white" />
        <div className="mx-auto max-w-4xl px-6 pb-14 pt-16 text-center">
          ...
          <Badge tone="info" className="mt-5 uppercase tracking-wide">Custom AIVRA Deployment</Badge>
          <h1 className="mt-4 text-[36px] font-bold leading-[1.1] tracking-tight text-ink-900 sm:text-[44px]">AI Voice Employee</h1>
          <p className="mt-2 text-[17px] font-medium text-info-600">Custom AI Voice Employee for Your Business</p>
          <p className="mx-auto mt-4 max-w-2xl text-[15px] leading-relaxed text-ink-600">
            Handles customer calls, enquiries, bookings, support and lead qualification — 24/7. Every AI Voice Employee is
            customized, configured and deployed by AIVRA's solution team for your specific business.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <Button size="lg" icon={<PhoneCall className="size-4" />} onClick={openCustomizationRequest}>
              Contact AIVRA for Customization
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20">
        <Card className="mb-6 border-info-100 bg-info-50/40">
          <CardBody className="flex items-start gap-3">
            ...
            <p className="text-[13px] leading-relaxed text-ink-700">
              This AI Employee is <span className="font-semibold">customized and deployed by AIVRA</span> — not a
        ...
        <p className="mt-6 text-center text-[13px] text-ink-400">
          Already have an AI Voice Employee? <Link to="/login" className="font-medium text-brand-600 hover:text-brand-700">Sign in</Link> to manage it.
        </p>
      </section>
