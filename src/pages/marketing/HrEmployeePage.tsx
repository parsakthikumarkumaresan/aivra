  ...
  return (
    <div className="min-h-screen bg-ink-25">
      ...
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[420px] bg-gradient-to-b from-brand-50/80 via-ink-25 to-ink-25" />
        <div className="mx-auto max-w-4xl px-6 pb-14 pt-16 text-center">
          ...
          <h1 className="mt-4 text-[36px] font-bold leading-[1.1] tracking-tight text-ink-900 sm:text-[44px]">Jexa HR</h1>
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20">
        ...
        <p className="mt-6 text-center text-[13px] text-ink-400">
          Already purchased? <Link to="/login" className="font-medium text-brand-600 hover:text-brand-700">Sign in</Link> to configure Jexa HR.
        </p>
      </section>
