...
export default function ConfigurationPage() {
  useSetBreadcrumbs([{ label: 'AI Employees', href: '/app/employees' }, { label: 'AI HR Employee', href: '/app/employees/hr' }, { label: 'Configuration' }])
  const config = useHrConfig()

  return (
    <div className="space-y-5">
      <PageHeader icon={<SlidersHorizontal className="size-5" />} title="Configuration" description="Administrator setup and testing tools for the AI HR Employee." />
      <HrSubNav />
